...
exports.Renderer.prototype = {
        ...
        function phase4(err) {
            fs.readFile(scriptPath, abind(function(err, data) {
                if (relink) {
                    ...
                    this.relinkScript(modulePath, data, false, compress, abind(phase5, cb, this)); 
                } else {
    ...
    renderContent: function(href, html, options, cb) {
        if (options.content == "inline") {
            this._getRenderPageScript(options, abind(function(err, script) {
                this._runInSandbox(script, href, html, cb);
            }, cb, this));
        } else {
            cb(0, html);
        }
    ...
    _getRenderPageScript: function(options, cb) {
    ...
    _runInSandbox: function(script, href, html, cb) {
        var pending = 0;
