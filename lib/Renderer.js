...
exports.Renderer.prototype = {
            ...
            if (options.css == "inline") {
                async.map(_.keys(deps.css),
                    _.bind(function(stylesheetPath, cb2) {
                        ...
                        source = replaceAll(source, deps.css[stylesheetPath].sourceLine, '');
                        cb2(0);
                    }, this),
                    _.bind(function(err) {
                        complete.apply(this);
    ...
    _scriptTags: function(urlPaths, options, cb) {
        ...
        if (process.env.NODE_ENV != 'production') {
            tags.push(scriptTagForSource('self.appjsDebugMode=true'));
        }
