...
exports.Renderer.prototype = {
            ...
            ibind(function(results, next) {
                ...
                if (options.js == "standalone") {
                    modules[scriptPath] =
                        ...
                        + newSource + '})({ready: function(cb) { cb() }}, {}, {});';
                } else {
                    modules[scriptPath] =
    ...
    _getLatestTimestamp: function(category) {
        ...
        } else if (category in this.dependencies) {
            var maxTime = 0;
            _.each(this.dependencies[this.app.client][category], function(dep) {
