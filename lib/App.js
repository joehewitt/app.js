...
function App(moduleName, clientModuleName, loader) {
...
exports.loadApp = function(moduleName, clientModuleName, loader, cb) {
    var app = new App(moduleName, clientModuleName, loader);    
